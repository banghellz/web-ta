            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="card-title">Login Activity Statistics</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="activity-logs-table" class="table table-vcenter table-nowrap table-hover">
                            <thead>
                                <tr>
                                    <th class="w-1">No</th>
                                    <th>User</th>
        ...
        <script>
            $(function() {
                ...
                function updateStats(stats) {
                    ...
                    $('#unique-users').text(stats.uniqueUsers || 0);
                }
                ...
                // Datepicker for date filter (if you have the datepicker library)
                if ($.fn.datepicker) {
