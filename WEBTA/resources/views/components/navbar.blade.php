<header class="bg-white" x-data ="{ isMobileOpen: false, isPOpen: false }">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12" x-data="{ isOpen: false }">
            <div class="relative">
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <div class="-mx-3">
                            <button type="button" @click="isPOpen=!isPOpen"
                  ...
                  -->
                                <svg class="size-5 flex-none" viewBox="0 0 20 20"
                                    fill="currentColor
                                   aria-hidden="true"
                                    data-slot="icon">
                                    <path fill-rule="evenodd"
                            ...
                            <div class="mt-2 space-y-2" id="disclosure-1" x-show ="isPOpen"
                                x-transition:enter-start="opacity-0 translate-y-1"
                                x-transition:enter-end="opacity-100 translate-y-0"
                                x-transition:leave="transition ease-in duration-150"
                                x-transition:leave-start="opacity-100 translate-y-0"
