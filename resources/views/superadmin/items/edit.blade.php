    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    <form action="{{ route('superadmin.items.update', $item->id) }}" method="POST" class="card">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <div>
                                <a href="{{ route('superadmin.items.index') }}" class="btn btn-outline-secondary">
        ...
        <script>
            $(document).ready(function() {
                ...
                function markItemAsMissing(itemId, reason) {
                    ...
                    $.ajax({
                        url: `/superadmin/missing-tools/mark-missing/${itemId}`,
                        method: 'POST',
                        data: {
                            reason: reason
                        },
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                setTimeout(function() {
                                    window.location.href = "{{ route('superadmin.items.index') }}";
                                }, 2000);
                            }
                        },
                        error: function(xhr) {
