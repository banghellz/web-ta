    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <!-- Dashboard -->
                <li class="nav-item">
                    <a class="nav-link text-gray-400 fw-semibold" href="{{ route('admin.dashboard.index') }}">
                    ...
                    <div class="dropdown-menu bg-dark">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item text-gray-400 fw-semibold"
                                    href="{{ route('admin.rfid-tags.index') }}">
                                    <i class="ti ti-device-mobile me-2"></i>
                                    RFID
                                </a>
                                <a class="dropdown-item text-gray-400 fw-semibold"
                                    href="{{ route('admin.log_peminjaman.index') }}">
                ...
                <!-- Activity Log -->
                <li class="nav-item">
                    <a class="nav-link text-gray-400 fw-semibold" href="{{ route('admin.activity-logs.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <!-- Missing Tools -->
                <li class="nav-item">
                    <a class="nav-link text-gray-400 fw-semibold" href="{{ route('admin.missing-tools.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
