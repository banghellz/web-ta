<aside class="navbar navbar-vertical navbar-expand-lg navbar-transparent" id="main-sidebar">
    <div class="container-fluid">
        <!-- Logo and toggle placement improved -->
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('superadmin.users.index') }}">Users</a>
                                <a class="dropdown-item" href="{{ route('superadmin.items.index') }}">Tools</a>
                                <a class="dropdown-item" href="{{ route('superadmin.rfid-tags.index') }}">RFID</a>
                                <a class="dropdown-item" href="{{ route('superadmin.log_peminjaman.index') }}">Borrowing
                                    History</a>
                            </div>
                        </div>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('superadmin.activity-logs.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="nav-item mt-auto">
                    <form method="GET" action="{{ route('logout') }}" class="m-0">
                        @csrf
                        <button type="submit"
                            class="nav-link btn btn-ghost-danger w-100 text-start border-0 bg-transparent">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
