<!-- resources/views/admin/items/detail-partial.blade.php -->
...
<script>
    $(document).ready(function() {
        ...
        window.refreshCoinInfo = function(userId) {
            ...
            $.ajax({
                url: `/admin/users/${userId}/coin-info`,
                method: 'GET',
                headers: {
        ...
        $('#confirmMarkMissing').on('click', function() {
            ...
            $.ajax({
                url: `/admin/missing-tools/mark-missing/${currentItemId}`,
                method: 'POST',
                headers: {
        ...
        $('#confirmReclaim').on('click', function() {
            ...
            $.ajax({
                url: `/admin/missing-tools/${currentMissingToolId}/reclaim`,
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')
