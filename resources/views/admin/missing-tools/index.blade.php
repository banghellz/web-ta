{{-- resources/views/admin/missing-tools/index.blade.php --}}
        ...
        <script>
            $(document).ready(function() {
                ...
                function showMissingToolDetail(missingToolId) {
                    ...
                    $.ajax({
                        url: `/admin/missing-tools/${missingToolId}`,
                        method: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': csrf
                        },
                ...
                function reclaimMissingTool(missingToolId) {
                    ...
                    $.ajax({
                        url: `/admin/missing-tools/${missingToolId}/reclaim`,
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': csrf
                        },
                ...
                function cancelMissingTool(missingToolId) {
                    ...
                    $.ajax({
                        url: `/admin/missing-tools/${missingToolId}/cancel`,
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': csrf
                        },
